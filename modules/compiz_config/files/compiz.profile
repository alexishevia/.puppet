...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;regex;wall;resize;move;place;animation;snap;put;gnomecompat;imgpng;vpswitch;mousepoll;session;grid;expo;workarounds;ezoom;staticswitcher;fade;
...
s0_outputs = 1366x768+0+0;1366x768+1366+0;
...
s0_put_next_output_key = <Alt>Right
s0_put_next_output_button = Disabled
s0_put_previous_output_key = <Alt>Left
