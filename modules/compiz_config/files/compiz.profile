...
s0_put_center_key = <Alt>KP_Begin
...
s0_put_topleft_key = <Alt>KP_Home
s0_put_topleft_button = Disabled
s0_put_topright_key = <Alt>KP_Prior
s0_put_topright_button = Disabled
s0_put_bottomleft_key = <Alt>KP_End
s0_put_bottomleft_button = Disabled
s0_put_bottomright_key = <Alt>KP_Next
